    ...
    $ax.public.navigate = $ax.navigate = function(to) { //url, includeVariables, type) {
        ...
        if(typeof (to) === 'object') {
            ...
            if(to.target == "new") {
                ...
                var sideFrame = window.parent.frames[1];

                    console.log("sideFrame", sideFrame);
                if(to.target == "current") {

                    console.log("current sideFrame");
                    sideFrame.postMessage({href: targetUrl}, "*");
                    return;
                    ...
                    return;
                } else if (to.target == "sideFrame" && sideFrame) {
                    console.log("sideFrame");
                    sideFrame.postMessage({href: targetUrl}, "*");
                    // $(sideFrame).attr('src', targetUrl);
                    return;
                }
